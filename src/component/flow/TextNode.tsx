  ...
  return (
    <div className="relative font-(--font-space-grotesk)">
      ...
      >
        ...
        <div
          className={`flex justify-between items-center text-[13px] font-medium mb-4 px-1 ${isLight ? "text-black/30" : "text-white/40"}`}
        >
          <span>Input</span>
          <span>Output</span>
        </div>
        ...
        <div className="flex items-center gap-4 mb-4 px-1">
          <button
            className={`${isLight ? "text-black/30 hover:text-black/60" : "text-white/20 hover:text-white/50"} transition-colors`}
          >
            <svg
              width="18"
              height="18"
