...
export function Dock({
  ...
  return (
    <div className={`w-[52px] h-full border-r ${isLight ? 'border-black/5 bg-white' : 'border-white/5 bg-[#080a0d]/95'} flex flex-col items-center gap-2.5 pt-3 transition-colors`}>
      <button
      ...
      <div className={`w-[30px] h-[1px] ${isLight ? 'bg-black/5' : 'bg-white/5'} my-1`} />
      ...
      <button
        ...
        aria-label="Palette"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>
      </button>
      ...
      <button
        ...
        aria-label="Files"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18M3 9h18"/></svg>
      </button>
      ...
      <button
        ...
        aria-label="Runs"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M13 3l-2 3H3v15h18V3h-8zm6 16H5V8h14v11z"/></svg>
      </button>
